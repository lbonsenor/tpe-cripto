...
Step 3. Use these r pixels fj(1), fj(2), fj(3),..., fj(r) and Lagrange’s interpolation to solve the coefficients a0, a1, a2 ,..., ar-1 in Eq. 5. They are exactly the r pixel values of the j-th section in Q. 
